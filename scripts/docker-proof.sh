...
assert interpretive_run.SCHEMA_VERSION == "waystation-ai-interpretive-run/1.7"
assert ai_authority.load_policy()["version"] == "1.2.0"
print("policy 1.4.0 + deep package/caption/benchmark/shadow + consolidated interpretive 1.7 adapters")
PY
