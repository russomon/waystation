...
assert interpretive_run.SCHEMA_VERSION == "waystation-ai-interpretive-run/1.5"
assert ai_authority.load_policy()["version"] == "1.1.0"
print("policy 1.4.0 + deep package/caption/benchmark/shadow + dual-key interpretive 1.5 adapters")
PY
